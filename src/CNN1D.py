...
def create_model(nb_pack):
    ...
    # model.add(tf.keras.layers.Dense(17 * nb_pack, input_dim=17, activation='relu'))
    # model.add(tf.keras.layers.Dense(17 * 2 * nb_pack, activation='relu'))
    # model.add(tf.keras.layers.Dense(int(17 * nb_pack * 0.6 + 42), activation='relu'))
